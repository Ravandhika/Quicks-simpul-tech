...
export const TodoAddTask = (props) => {
  ...
  const [emptyTodo, setEmptyTodo] = useState("No Description");
  const [emptyTaskName, setEmptyTaskName] = useState("Type Task Title");
  const [editing, setEditing] = useState(false);

  useEffect(() => {}, [date, emptyTodo]);

  // const handleChangeInput = (e) => {
  //   setTodoDesc(e.target.value);
  // };
  const handleSave = (emptyTodo, emptyTaskName) => {
    setEmptyTodo(emptyTodo);
    setEmptyTaskName(emptyTaskName);
    // setEditing(!editing);
  };
      ...
      <div className="flex flex-row items-center py-[22px] space-x-4 justify-between">
              ...
              <>
                <div className="w-full">
                  <EdiText
                    ...
                    className="text-[#4F4F4F] font-lato w-full font-bold"
                    editButtonProps={{
                      style: {
                        display: "none",
                      },
        ...
        <div className="">
          <Menu as="div" className="relative inline-block text-left">
            <div>
              <Menu.Button className="inline-flex justify-center w-full py-2 text-sm font-medium text-[#4f4f4f]  rounded-md">
                <Image
